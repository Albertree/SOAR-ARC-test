...
| `agent/conditions/` directory | bootstrapped on `test20`: `CONDITION_REGISTRY` + `grid_size_preserved` matcher (iter 1); `consistent_color_mapping` added in iter 8 (P5: 1 → 2); `sequential_recoloring` added in iter 10 (P5: 2 → 3) |
